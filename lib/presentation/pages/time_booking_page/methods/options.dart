...
List<Widget> options<T>({
  ...
  String Function(T object)? converter, // untuk pemlilihan tanggal
  bool Function(T object)?
      isOptionEnable, // pilihan yang bisa di pilih atau tidak
      ...
      SingleChildScrollView(
        ...
        child: Row(
          children: options
              ...
              .toList(), // iterable dimulai dari .map
        ),
      )
    ];
