...
import 'package:flix_id/presentation/pages/seat_booking_page.dart/seat_booking_page.dart';
...
Raw<GoRouter> router(RouterRef ref) => GoRouter(routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => SeatBookingPage(
          transactionDetail: state.extra as (
            MovieDetail,
            Transaction
          ), // record untuk ngambil data sebelumnya
        ),
      ),
      GoRoute(
    ...
    //jangan pasang const pada builder yang memungkin halaman tersebut untuk selalu update data
