    ...
    return _then(_value.copyWith(
      ...
      watchingTime: freezed == watchingTime
          ...
          : watchingTime // ignore: cast_nullable_to_non_nullable
              as int?,
      ticketAccount: freezed == ticketAccount
...
class _$TransactionImpl implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(id: $id, uid: $uid, transactionTime: $transactionTime, transactionImage: $transactionImage, title: $title, seats: $seats, theaterName: $theaterName, watchingTime: $watchingTime, ticketAccount: $ticketAccount, ticketPrice: $ticketPrice, ticketAmount: $ticketAmount, adminFee: $adminFee, total: $total)';
  }
